...
// Import regional tab components
import TabGambaranUmum from "@/components/regional/TabGambaranUmum";
import TabBadanUsaha from "@/components/regional/TabBadanUsaha";
import TabTenagaKerja from "@/components/regional/TabTenagaKerja";
import TabUnitPembinaan from "@/components/regional/TabUnitPembinaan";
import TabKelembagaan from "@/components/regional/TabKelembagaan";
import TabAnggaran from "@/components/regional/TabAnggaran";
import TabKegiatan from "@/components/regional/TabKegiatan";
        ...
        {!selectedKabupaten ? (
          ...
          <section className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-3xl border border-gray-150 p-6 sm:p-10 shadow-sm min-h-[300px]">
              {activeTab === "Gambaran Umum" && currentData && (
                <TabGambaranUmum stats={currentData.stats} />
              )}

              {activeTab === "Badan Usaha" && currentData && (
                <TabBadanUsaha stats={currentData.stats} buComposition={currentData.buComposition} />
              )}

              {activeTab === "Tenaga Kerja" && currentData && (
                <TabTenagaKerja stats={currentData.stats} kabupatenName={currentData.name} />
              )}

              {activeTab === "Unit Pembinaan" && currentData && (
                <TabUnitPembinaan kabupatenName={currentData.name} />
              )}

              {activeTab === "Kelembagaan" && currentData && (
                <TabKelembagaan kabupatenName={currentData.name} />
              )}

              {activeTab === "Anggaran" && currentData && (
                <TabAnggaran stats={currentData.stats} kabupatenName={currentData.name} />
              )}

              {activeTab === "Kegiatan" && currentData && (
                <TabKegiatan kabupatenName={currentData.name} />
              )}
            </div>
          </section>
        )}
